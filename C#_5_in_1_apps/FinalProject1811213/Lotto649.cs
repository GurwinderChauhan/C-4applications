	...
	public partial class Lotto649 : Form
	{
		...
		private void generatetxt_Click(object sender, EventArgs e)
		{
			...
			try
			{
				...
				textOut.Write("649;" + datetime + ";" + messagetxt.Text + ";" + "Bonus " + messagetxt.Text[7] + "\n");
		...
		{
			MessageBox.Show(File.ReadAllText(@"..\..\..\Lotto649.Text"),"Gurwinder", MessageBoxButtons.OK);
		}
